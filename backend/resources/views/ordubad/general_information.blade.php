     ...
     <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Ümumi məlumat</h3>
                        </div>
                        <div class="block-content">
                        @include('settings.errors')
                            <form action="{{ route('general_information.update',1) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('put')
                                <div class="row push">
                                    <div class="col-lg-12 col-xl-12 overflow-hidden">
                                             @if($general_Information)
                                                  <img src="{{ asset($general_Information->img) }}" alt="{{ $general_Information->img }}" style="width:250px; height:250px" />
                                             @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($general_Information)
                                             <textarea class="form-control" id="editor" name="description" rows="4" placeholder="Açıqlama daxil et...">{!! $general_Information->description !!}</textarea>
                                            @else
