     ...
     <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">{{ $daily->title }} Redaktə et</h3>
                        </div>
                              ...
                              @method('PUT')
                                <div class="row push">
                                    <div class="col-lg-12 col-xl-12 overflow-hidden">
                                        <h6>Cari Rəsm</h6>
                                        <img src="{{ asset($daily->img) }}" style="width:250px; height:200px; margin-bottom:10px" alt="{{ $daily->title }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="title" value="{{ $daily->title }}" placeholder="Başlıq Daxil Edin..." />
                                        </div>
                                        <div class="form-group">
                                            <label for="js-ckeditor5-classic">Açıqlama</label>
                                             <textarea class="form-control" id="editor" name="description" rows="4">{!! $daily->description !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group d-flex justify-content-between">
                                    <a href="{{ route('daily.index') }}" class="btn btn-md btn-primary">Geri</a>
