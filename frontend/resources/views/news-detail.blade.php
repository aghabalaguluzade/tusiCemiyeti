                            ...
                            <div class="col-lg-8 m-15px-tb">
                                <article class="article">
                                    ...
                                    <div class="article-title">
                                        <h2>Xarabagilan yaşayış məntəqəsinin tarixi</h2>
                                    </div>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="latest-post-aside media">
                                            <div class="lpa-left media-body">
                                                <div class="lpa-title">
                                                    <h5><a href="#">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                            Alias, accusantium.</a></h5>
                                                </div>
                                                <div class="lpa-meta">
                                                    <a class="date" href="#">
                                                        12.02.2023
                                            ...
                                            <div class="lpa-right">
                                                <a href="#">
                                                    <img src="https://climate.onep.go.th/wp-content/uploads/2020/01/default-image.jpg" title="" alt="" class="img-fluid">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="latest-post-aside media">
