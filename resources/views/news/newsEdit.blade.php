     ...
     <div class="content">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">{{ $news->title }} Redaktə et</h3>
                        </div>
                              ...
                              @method('PUT')     
                                <div class="row push">
                                    <div class="col-lg-12 col-xl-12 overflow-hidden">
                                        <h6>Cari Rəsm</h6>
                                        <img src="{{ asset($news->img) }}" style="width:250px; height:200px; margin-bottom:10px" alt="{{ $news->title }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="title" value="{{ $news->title }}" placeholder="Başlıq Daxil Edin..." />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <option value="1" {{ $news->status == 1 ? "selected" : "" }}>Aktiv</option>
                                             <option value="0" {{ $news->status == 0 ? "selected" : "" }}>Deaktiv</option>
                                             </select>
                                        </div>
                                    </div>
                                </div>
